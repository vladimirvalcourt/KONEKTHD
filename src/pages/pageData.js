...
export const pageData = {
  ...
  "/help-center": {
    ...
    sections: [
      ...
      { title: bilingual("Provider accounts", "Kont founisè"), body: bilingual("Providers can sign in with Apple, Google, or a one-time email code. They can delete their account from the provider account page.", "Founisè yo ka konekte ak Apple, Google, oswa yon kòd yon sèl fwa pa imèl. Yo ka efase kont yo sou paj kont founisè a.") },
  ...
  "/privacy-policy": {
    ...
    sections: [
      ...
      { title: bilingual("Provider accounts and sign-in", "Kont founisè ak koneksyon"), body: bilingual("Providers sign in through Supabase using Apple, Google, or a one-time email code. Apple and Google may share an account ID, name, email address, and profile image based on the provider's choices. KONEKT uses account information to confirm who may manage a submitted profile.", "Founisè yo konekte atravè Supabase ak Apple, Google, oswa yon kòd yon sèl fwa pa imèl. Apple ak Google ka bay yon idantifyan kont, non, adrès imèl, ak foto pwofil selon sa founisè a chwazi. KONEKT sèvi ak enfòmasyon kont lan pou konfime kiyès ki gen dwa jere yon pwofil.") },
