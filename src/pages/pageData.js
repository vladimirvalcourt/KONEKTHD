...
export const pageData = {
  ...
  "/help-center": {
    ...
    sections: [
      ...
      { title: bilingual("Provider accounts", "Kont founisè"), body: bilingual("Providers can use Apple, Google, or a one-time email code in the iPhone app. Account deletion is available from the provider workspace.", "Founisè yo ka sèvi ak Apple, Google, oswa yon kòd yon sèl fwa pa imèl nan aplikasyon iPhone lan. Yo ka efase kont yo nan espas founisè a.") },
  ...
  "/privacy-policy": {
    ...
    sections: [
      ...
      { title: bilingual("Provider accounts and sign-in", "Kont founisè ak koneksyon"), body: bilingual("Providers authenticate through Supabase using Apple, Google, or a one-time email code. Apple and Google may provide an account identifier, name, email address, and profile image according to the provider's consent screen and settings. KONEKT uses account and provider-workspace information to protect ownership and manage submitted listings.", "Founisè yo konekte atravè Supabase ak Apple, Google, oswa yon kòd yon sèl fwa pa imèl. Apple ak Google ka bay yon idantifyan kont, non, adrès imèl, ak foto pwofil selon ekran konsantman ak reglaj sèvis la. KONEKT sèvi ak enfòmasyon kont ak espas founisè pou pwoteje pwopriyetè a epi jere pwofil yo voye.") },
      ...
      { title: bilingual("Service providers and sharing", "Sèvis ki ede nou ak pataj done"), body: bilingual("KONEKT uses Supabase for authentication, database, protected file storage, and server functions, and uses Apple or Google when a provider chooses those sign-in methods. KONEKT does not sell personal information. Data may be disclosed when required by law or when needed to protect users, the service, or legal rights.", "KONEKT sèvi ak Supabase pou koneksyon, bazdone, depo fichye pwoteje, ak fonksyon sèvè; li sèvi ak Apple oswa Google lè yon founisè chwazi fason sa yo pou konekte. KONEKT pa vann enfòmasyon pèsonèl. Nou ka pataje done si lalwa mande sa oswa si sa nesesè pou pwoteje moun, sèvis la, oswa dwa legal.") },
      { title: bilingual("Retention and security", "Kantite tan ak sekirite"), body: bilingual("KONEKT keeps provider-account and workspace information while the account is active and as needed for review, safety, fraud prevention, dispute handling, or legal obligations. Access controls, protected transport, and restricted evidence workflows reduce risk, but no system can guarantee absolute security.", "KONEKT kenbe enfòmasyon kont ak espas founisè pandan kont lan aktif epi jan sa nesesè pou revizyon, sekirite, prevansyon fwod, rezoud dezakò, oswa obligasyon legal. Kontwòl aksè, transmisyon pwoteje, ak chemen limite pou dokiman diminye risk, men okenn sistèm pa ka garanti sekirite nèt.") },
