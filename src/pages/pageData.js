...
export const pageData = {
  ...
  "/list-your-business": {
    ...
    steps: [
      ...
      { number: "02", title: bilingual("Tell people what they need to know", "Bay moun enfòmasyon yo bezwen"), body: bilingual("Add your contact information, hours, services, public photo, the languages spoken at your practice (English, Creole, Spanish, French, etc.), and how language support is provided.", "Ajoute kontak, lè, sèvis, foto piblik, lang ekip ou pale yo (Anglè, Kreyòl, Espanyòl, Fransè, elatriye), ak kijan ou bay èd nan lang yo.") },
